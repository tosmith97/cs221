...
def get_emotion_data():
    happy_df = get_feats_df('song_features/happy_feats.pickle')
    happy_df['Emotion'] = 0

    sad_df = get_feats_df('song_features/sad_feats.pickle')
    sad_df['Emotion'] = 1

    excited_df = get_feats_df('song_features/excited_feats.pickle')
    excited_df['Emotion'] = 2

    chill_df = get_feats_df('song_features/chill_feats.pickle')
    chill_df['Emotion'] = 3
